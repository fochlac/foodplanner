...
module.exports = (user, meal) => ({
  ...
  html: `<style>p {margin: 3px 0;}h3,h4{margin: 5px 0 7px; flex-direction: column;}</style>
    ...
    <br>
    <hr>
    <p><a href="https://${process.env.FOOD_EXTERNAL}/unsubscribe?id=${user.id}&list=creationNotice">Klicke hier</a>, um dich von dieser Liste abzumelden <a href="https://${process.env.FOOD_EXTERNAL}/unsubscribe?id=${user.id}">oder hier</a>,  um alle Emails von dieser Seite abzubestellen.</p>
