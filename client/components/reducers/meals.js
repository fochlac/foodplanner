  ...
  switch (action.type) {
    ...
    case "EDIT_MEAL":
      if (action.status === "complete") {
        ...
        newState[mealIndex] = Object.assign(
          {},
          newState[mealIndex],
          action.data
        );
    ...
    case "SUBMIT_PRICES":
      if (action.status === "complete") {
        let newState = [].concat(state),
          ...
          clonedMeal = Object.assign(
            {},
            newState[mealIndex],
            priceReference.m ? { price: priceReference.m } : {}
          );
        ...
        clonedMeal.options = newState[mealIndex].options.map(option =>
          Object.assign(
            {},
            option,
            priceReference.o[option.id]
              ? { price: priceReference.o[option.id] }
              : {},
            {
