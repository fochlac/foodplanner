...
export default class AddressBlock extends React.Component {
    ...
    handleBlur(field) {
        return () => !this.state.address[field].length || this.state.dirty.includes(field) || this.setState({ dirty: [...this.state.dirty, field] })
    }
            ...
            <div className="col alignStart">
                <div className="row">
                    <div className="basis66 alignStart">
                        <label className="noWrap" htmlFor="street">{wording.street}<span className="fa fa-asterisk required"></span></label>
                    ...
                    <div className="basis33 alignStart">
                        <label className="noWrap" htmlFor="number">{wording.number}<span className="fa fa-asterisk required"></span></label>
                ...
                <div className="row">
                    <div className="basis33 alignStart">
                        <label className="noWrap" htmlFor="postal">{wording.postal}<span className="fa fa-asterisk required"></span></label>
                    ...
                    <div className="basis66 alignStart">
                        <label className="noWrap" htmlFor="city">{wording.city}<span className="fa fa-asterisk required"></span></label>
                ...
                <div className="fullWidth">
                    <label className="noWrap" htmlFor="country">{wording.country}<span className="fa fa-asterisk required"></span></label>
