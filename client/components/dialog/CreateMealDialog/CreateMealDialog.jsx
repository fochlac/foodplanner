...
var wording = {
  ...
  linkInfo: ['Um Links einzubinden, können Sie Markdown verwenden:', <br key="1"/>, ' [Linkname](http://www.link.de)'],
}
...
export default class CreateMealDialog extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (!sEqual(nextProps.meals, this.props.meals) || nextProps.historyLoaded !== historyLoaded) {
      return true
    }
    return false
  }
