...
const user = {
  ...
  actions = {
    ...
    show_incoming_payments: () => (output = 'show_incoming_payments'),
  }
...
describe('UserFrame', () => {
  test('should render a registered frame', () => {
    ...
    expect(wrapper.find('.incomingPaymentsLink')).toHaveLength(1)
  })
  ...
  test('should render a registered frame', () => {
    ...
    wrapper.find('.incomingPaymentsLink').simulate('click')
    expect(output).toBe('show_incoming_payments')
  })
})
