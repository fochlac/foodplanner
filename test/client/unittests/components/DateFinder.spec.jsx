...
describe('DateFinder', () => {
  ...
  test('should allow admin to toggle dates if signup Icon is not in classlists', () => {
    ...
    wrapper
      .find('.datesList li > div')
      .at(2)
      .simulate('click', evtTarg(true))
    expect(output).toEqual(false)
    wrapper
      .find('.datesList li > div')
      .at(2)
      .simulate('click', evtTarg(false))
  ...
  test('should allow admin to lock the datefinder and select a date', () => {
    ...
    expect(
      wrapper
        .find('.finalizeList > li')
        .at(0)
        .find('.participantsList > li'),
    ).toHaveLength(2)
    expect(
      wrapper
        .find('.finalizeList > li')
  ...
  test('should render user list when clicked', () => {
    ...
    expect(
      wrapper
        .find('.datesList li')
        .at(1)
        .find('.userListWrapper'),
    ).toHaveLength(1)
    expect(
      wrapper
        .find('.datesList li')
        .at(1)
        .find('.userListWrapper li'),
    ).toHaveLength(2)
